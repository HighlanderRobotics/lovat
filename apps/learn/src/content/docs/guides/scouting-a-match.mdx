...
<Phone src={autoAllianceZone} alt="auto alliance zone" orientation="landscape-left" />
...
Additional autonomous actions include:

- Feeding fuel to alliance partners
- Using the outpost (select intake or outtake)
- Climbing during autonomous

<Phone src={autoNeutral} alt="auto neutral" orientation="landscape-left" />

Record these actions as they occur.
