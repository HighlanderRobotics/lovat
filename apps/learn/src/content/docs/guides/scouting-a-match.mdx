...
Some things that can be included are
 ...
 - Penalties caused by the robot, such as if they frequently were in the other team's reef zone
 ...
 - Strategies such as scoring in the other alliance's processor or using a buddy auto

Some examples of good notes could be
 - Lost comms with 15s left. Small intake, human players couldn’t line up coral properly. 
 - Got lots of penalties for being in the other alliance’s reef
 - Tipped with 20s left after algae got stuck under them
