...
<div class="match-card">
	...
	<div class="footer">
		...
		<div
			class="prediction"
			class:has-prediction={match.alliances.red.winPrediction && match.alliances.blue.winPrediction}
		>
			{#if match.alliances.red.winPrediction && match.alliances.blue.winPrediction}
				<div class="red-portion" style:width={match.alliances.red.winPrediction * 100 + '%'} />
